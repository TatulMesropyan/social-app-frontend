...
export const DeletePostDialog = ({setConfirmDelete,confirmDelete,showSubmitDeleteDialog}) => {
	const dispatch = useDispatch();
	return (
		<Dialog onClose={() => dispatch(deletePostDialog())} open={showSubmitDeleteDialog}>
			<DialogContent>
				<Box sx={{
					display: "flex",
